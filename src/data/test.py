...
for i in collabResp["channels"]:
    ...
    tempDict["group"] = temp[collabResp["channels"]
                             [i]["channel_info"]["yt_channel_id"]]["group"]
    ...
    tempDict["channelActive"] = temp[collabResp["channels"]
                                     [i]["channel_info"]["yt_channel_id"]]["channelActive"]
