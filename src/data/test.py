...
for i in collabResp["channels"]:
    ...
    tempDict["group"] = temp[collabResp["channels"][i]["channel_info"]["yt_channel_id"]]["group"]
    tempDict["avatar_url"] = collabResp["channels"][i]["avatar_url"]
    tempDict["banner_url"] = collabResp["channels"][i]["channel_info"]["banner"]
    tempDict["subscriberCount"] = int(collabResp["channels"][i]["channel_info"]["yt_stats"]["subscriberCount"])
    tempDict["videoCount"] = int(collabResp["channels"][i]["channel_info"]["yt_stats"]["videoCount"])
    tempDict["viewCount"] = int(collabResp["channels"][i]["channel_info"]["yt_stats"]["viewCount"])
    tempDict["lastUpdateTime"] = currentDate.strftime("%Y-%m-%d")
    tempDict["channelActive"] = temp[collabResp["channels"][i]["channel_info"]["yt_channel_id"]]["channelActive"]
